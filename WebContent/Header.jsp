					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
							...
							<li class="dropdown">
								...
								<a href="#" class="dropdown-toggle hyper" data-toggle="dropdown" ><span> My Cart <b class="caret"></b></span></a>
								<ul class="dropdown-menu multi multi1">
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
												<li><a href="Cart.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i> Current Items </a></li>
												<li><a href="Cart.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i> Saved Items</a></li>
